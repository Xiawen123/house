...
<!--显示街道对话框-->
<div id="showStreetDialog" class="easyui-dialog" buttons="#showStreetButtons"
     style="width: 600px; height:450px; padding: 10px 20px;" closed="true">
    <table id="aaa"></table>
    <hr/>
    <form method="post" action="" id="form3" name="form1">
        街道名称:<input type="text" name="name" id="StreetName"><span  id="showStreet"></span>
      <br>
        区域名称:<input type="text" name="districtId" value=""  id="districtname" readonly="readonly"><br>
        <input  type="button"  value="添加" id="button">
    </form>
</div>
<!--显示街道对话框-->
<div id="showStreetButtons">
    <a href="javascript:" class="easyui-linkbutton"
       iconCls="icon-ok">更新</a> <a href="javascript:CloseAddDialog('showStreetDialog')"
                                   class="easyui-linkbutton" iconCls="icon-cancel">取消</a>
</div>
