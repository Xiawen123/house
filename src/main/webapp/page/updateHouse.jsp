                ...
                <DIV class=infos>
                    <TABLE class=field>
                        ...
                        <TR>
                            ...
                            <TD><INPUT    class=text value="${house.id}" type=hidden name=id> </TD></TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><INPUT id="pic" class=text type=file name=pfile>
                                <INPUT  class=text type=hidden name=delimage value="${house.path}"> <%--旧图片的地址--%>
                                <br></TD>
                        </TR>
                        <TR>
                            <TD><img src="http://localhost:80/${house.path}" height="70" width="60"></TD>
                        </TR>
                        <TR>
